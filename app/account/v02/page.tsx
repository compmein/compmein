...
import { useTokenBalance } from "@/app/create/useTokenBalance";
...
<div className="mt-4 grid items-stretch gap-3 sm:grid-cols-2 lg:grid-cols-4">
  {[
    ...
    { title: "Ultra", price: "$49.99", tokens: "5000" },
  ].map((p) => (
    <div
  key={p.title}
...
>
  ...
  <button
    disabled
    className="w-full rounded-xl bg-neutral-900 px-3 py-2 text-sm text-white opacity-40"
    title="Coming soon"
  >
    Coming soon
  </button>
