...
export default function CreatePage() {
  ...
  async function runAdvancedCombine() {
    if (!referenceDataUrl) {
      alert("请先上传 Reference Clothing/Object/Pose 图片（没有 reference 就直接下载即可）");
      return;
    }
    ...
    try {
      ...
      // 2) 拼成 NanoBanana 输入图（只发一张图）
      const inputDataUrl = await buildNanobananaInput({
        stageDataUrl,
        stageW: STAGE_W,
        stageH: STAGE_H,
        referenceDataUrl,
    ...
    <div className="space-y-6">
        ...
        <div className="mt-4 grid gap-4 lg:grid-cols-3">
          ...
          <div className="lg:col-span-2 space-y-4">
            <div className="flex gap-4">
              ...
              {hasReference && (
                <div className="w-[360px] shrink-0 rounded-2xl border-4 border-black bg-white p-4">
                  <div className="text-center text-sm font-semibold">
                    Reference Clothing/Object/Pose
                  </div>
                  <div className="mt-3 rounded-xl border-4 border-black p-4">
              ...
              <div className="grid gap-4 lg:grid-cols-3">
                <div>
                  ...
                  <div className="mt-4 text-xs text-neutral-500">
                    规则：没有 reference 就直接下载客户合成图；只有上传 reference 才开启 Advanced Combine。
                  </div>
                </div>
                ...
                <div className="lg:col-span-2 space-y-3">
                  ...
                  <div className="flex flex-wrap gap-3">
                    ...
                    <button
                      ...
                      disabled={!hasReference || isCombining}
                      title={!hasReference ? "先上传 reference 才能用 Advanced Combine" : ""}
                    >
            ...
            <div className="grid gap-4 lg:grid-cols-2">
              <div className="rounded-3xl border bg-white p-6 shadow-sm">
                <div className="flex items-center justify-between">
                  <div>
                    <div className="text-base font-semibold">客户合成结果</div>
                    <div className="text-sm text-neutral-600">（你在画布里手动摆好的版本）</div>
                  </div>
                  <button
                    onClick={downloadCustomer}
              ...
              <div className="rounded-3xl border bg-white p-6 shadow-sm">
                <div className="flex items-center justify-between">
                  <div>
                    <div className="text-base font-semibold">AI 输出结果</div>
                    <div className="text-sm text-neutral-600">（Advanced Combine 生成）</div>
                  </div>
                  <button
                    onClick={downloadAI}
                    className="rounded-xl bg-neutral-900 px-4 py-2 text-sm text-white hover:opacity-90 disabled:opacity-40"
      ...
      <div className="rounded-3xl border bg-white p-6 shadow-sm">
        ...
        <ul className="mt-3 list-disc space-y-1 pl-5 text-sm text-neutral-700">
          <li>没有 reference：你只需要下载“客户合成结果”。</li>
          <li>有 reference：Advanced Combine 会把「客户合成截图 + reference 面板」拼成 1 张图发给 NanoBanana。</li>
          <li>AI 输出会单独显示在下方，并可单独下载。</li>
        </ul>
      </div>
    </div>
  );
