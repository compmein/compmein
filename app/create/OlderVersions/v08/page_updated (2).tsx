  ...
  async function doRemoveBg() {
    ...
    try {
      ...
      try {
        ...
        safeSetLocalStorage("lastCutPngDataUrl", dataUrl);
      } catch {
        // ignore
      }
    } catch (err) {
      ...
      <div className="rounded-3xl border bg-white p-6 shadow-sm">
        ...
        <div className="mt-4 grid gap-4 lg:grid-cols-3">
          ...
          <div className="lg:col-span-2 space-y-4">
            ...
            {/* ✅ Advanced Combine 区块（可折叠，默认展开） */}
            <details open className="rounded-3xl border bg-white p-6 shadow-sm">
              <summary className="cursor-pointer select-none text-base font-semibold">Advanced Combine</summary>
