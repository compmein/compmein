...
Inputs:
- Image 1 (Primary): the base scene (person + background).
- Image 2 (Reference, optional): use ONLY for clothing/accessories/objects guidance.

Rules:
1) Preserve the person's identity, facial features, and pose exactly as in Image 1.
2) If Image 2 is provided, apply ONLY the clothing/accessories/objects from Image 2 onto the person in Image 1.
3) Match lighting and shadows to Image 1. Do NOT include Image 2 or any UI elements in the final output.
`.trim();
...
export default function CreatePage() {
  ...
  useEffect(() => {
    if (!storedPersonDataUrl && subjectChoice === "uploaded") setSubjectChoice("none");
  }, [storedPersonDataUrl, subjectChoice]);
